...
PillSurface {
    ...
    readonly property string usageFile: (Quickshell.env("XDG_STATE_HOME") || (Quickshell.env("HOME") + "/.local/state")) + "/lumen/launcher-usage.json"
    ...
    ListView {
        ...
        delegate: Item {
            ...
            readonly property bool isAppImage: entry && entry.id && entry.id.indexOf("lumen-") === 0
